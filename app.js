...
(function() {
  ...
  setTitle = function(title) {
    return document.docTitle = title;
  };
  ...
  setTitleInDOM = function() {
    return $("#doc-title").text(": " + getTitle());
  };
