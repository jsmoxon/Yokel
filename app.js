...
(function() {
  ...
  setupDOMListeners = function() {
    ...
    return $("#picbox-input").bind('keypress', function(event) {
      if (event.which === 13) {
        event.preventDefault();
