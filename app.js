...
(function() {
  var CL_KEY, MSG_MSG_KEY, MSG_USER_KEY, NEW_VISIT_MEMORY, PB_KEY, addCollaboratorToDOM, addMsgToDOM, addMsgToModel, alertPageTitle, clearTitlePing, createChatList, createPictureBox, fetchName, getChatList, getCollaborators, getDocument, getModel, getName, getPicture, handleSmartMessage, initializeDocument, initializeModel, populateTailList, postMessage, setDocument, setModel, setName, setPicture, setPictureBoxLocal, setupChatListener, setupCollaboratorsDOM, setupDOMListeners, setupListeners, setupPictureBoxListener, setupUpdateCollaboratorsListener, structureMessage,
    _this = this;
  ...
  handleSmartMessage = function(msg) {
    if (msg.length > 4) {
      if (msg.slice(0, 4) === 'pic:') {
        return setPicture(msg.slice(4));
      }
    }
  };
